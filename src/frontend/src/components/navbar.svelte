<script lang="ts">
	...
	import ProfileOptionLink from "./navbar/profileOptionLink.svelte";
		...
		<div class="relative flex h-16 items-center justify-between">
			...
			<div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
				<div class="flex flex-shrink-0 items-center">
					<a class="hover:dark:bg-gray-700 rounded-md px-3 py-2" href="/">{title}</a>
				</div>
				...
				<div class="relative ml-3">
                    ...
                    >
                        ...
                        <img
                            ...
                            src="https://plus.unsplash.com/premium_photo-1695725168367-d2fc4c65d852?w=700&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjF8fG1hc2tlZCUyMGZpZ3VyZXxlbnwwfHwwfHx8MA%3D%3Dw=256&h=256&q=80"
                            alt=""
                        />
                    </button>
